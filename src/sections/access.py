...
def render_new():
    with st.container(key="access_container"):
        st.markdown(
            """
            <h3>Access to Health Amenities</h3>
            <p>Access to health amenities is crucial for ensuring that individuals can receive timely and appropriate medical care. This section visualizes the distribution of various health amenities across different regions, helping to identify areas with limited access.</p>
            """,
